...
import { useAuth } from '../../auth/hook/userAuth.js'
            ...
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    <div className="nav-content">
                        ...
                        <div>
                            <button onClick={handleLogouts} className='btn-primary'>Logout</button>
                        </div>
                    </div>
                    <button
                    ...
                    {activeNav === 'roadmap' && (
                        <section>
                            <div className='content-header'>
                                ...
                                <span className='content-header__count'>{report.prep?.length || 0}-day plan</span>
                            </div>
